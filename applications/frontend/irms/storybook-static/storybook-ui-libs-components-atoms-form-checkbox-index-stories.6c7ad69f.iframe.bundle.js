"use strict";(self.webpackChunkirms=self.webpackChunkirms||[]).push([[1107],{"./src/storybook/ui-libs/components/atoms/form/checkbox/index.stories.jsx"(__unused_webpack_module,__webpack_exports__,__webpack_require__){__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{Base:()=>Base,__namedExportsOrder:()=>__namedExportsOrder,default:()=>index_stories});var prop_types=__webpack_require__("./node_modules/prop-types/index.js"),prop_types_default=__webpack_require__.n(prop_types),ui_helpers=__webpack_require__("./build/scripts/ui-helpers/index.js"),react=__webpack_require__("./node_modules/react/index.js"),typography_text=__webpack_require__("./scrap/ui-libs/components/atoms/typography/text/index.jsx"),display=__webpack_require__("./scrap/ui-libs/components/atoms/typography/display/index.jsx"),layer_holder=__webpack_require__("./scrap/ui-libs/components/atoms/layer-holder/index.jsx");function _define_property(obj,key,value){return key in obj?Object.defineProperty(obj,key,{value:value,enumerable:!0,configurable:!0,writable:!0}):obj[key]=value,obj}function _object_spread(target){for(var i=1;i<arguments.length;i++){var source=null!=arguments[i]?arguments[i]:{},ownKeys=Object.keys(source);"function"==typeof Object.getOwnPropertySymbols&&(ownKeys=ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function(sym){return Object.getOwnPropertyDescriptor(source,sym).enumerable}))),ownKeys.forEach(function(key){_define_property(target,key,source[key])})}return target}var Checkbox=function Checkbox(dprops){var lblJsx,props=ui_helpers.element.jsx.props.define({},dprops),id=ui_helpers.random.id(10),ids={checkbox:"".concat(id,"Chkbx"),checkboxName:"".concat(id,"ChkbxNme"),checkboxHolder:"".concat(id,"ChkbxHldr")};(0,react.useEffect)(function(){toggle(props.checked)},[props.checked]);var toggle=function toggle(chkd){chkd?ui_helpers.element.attr.set(ids.checkbox,"checked",!0):ui_helpers.element.attr.remove(ids.checkbox,"checked")},onChange=function onChange(chcked){ui_helpers.data.type.is(props.onChange,"function")&&props.onChange(chcked,_object_spread({},props,{ids:ids}))},onClick=function onClick(e){if(!props.disabled){var chcked=ui_helpers.element.attr.get(ids.checkbox,"checked");e.preventDefault(),e.stopPropagation(),toggle(!chcked),onChange(!chcked)}},heading=function heading(){var lbl=ui_helpers.json.val(props,"label");if(lbl)return react.createElement(display.A,{content:lbl,ds:ui_helpers.json.val(props,"labelDs"),element:ui_helpers.json.val(props,"labelDs.element","span")})},description=function description(){var desc=ui_helpers.json.val(props,"description");return desc?react.createElement(typography_text.A,{content:desc,ds:ui_helpers.json.val(props,"descriptionDs",{}),moreLess:{enabled:!1}}):react.createElement(react.Fragment,null)},labelClass=function labelClass(){var rv=["cp chkbx-lbl"];return props.disabled&&rv.push("disabled"),rv.join(" ")},chckClass=function chckClass(){var rval=["chkbx-wrpr chkbx th-".concat(ui_helpers.json.val(props,"theme","000"))];return props.disabled&&rval.push("disabled"),rval.join(" ")};return react.createElement(layer_holder.A,{layer:function switchBox(){return react.createElement("label",{className:chckClass(),htmlFor:ids.checkbox,onClick:function onClick1(e){onClick(e)}},react.createElement("input",{type:"checkbox",id:ids.checkbox,value:props.value||"",disabled:props.disabled,name:props.name||ids.checkboxName}),react.createElement("span",{className:"chkbx-inpt inpt transition bdr-4 bdr-1"}))},content:(lblJsx=ui_helpers.json.val(props,"labelJsxTemplate"))?react.createElement("label",{className:labelClass(),htmlFor:ids.checkbox,onClick:function onClick1(e){onClick(e)}},lblJsx):react.createElement("label",{className:labelClass(),htmlFor:ids.checkbox,onClick:function onClick1(e){onClick(e)}},heading(),description()),moreLess:{enabled:!1},attrs:ui_helpers.json.val(props,"attrs",{}),layerDs:ui_helpers.json.val(props,"layerDs",{}),dataAttrs:ui_helpers.json.val(props,"dataAttrs",{}),wrapperDs:ui_helpers.json.val(props,"wrapperDs",{})})};Checkbox.propTypes={layerDs:prop_types_default().object,labelDs:prop_types_default().object,descriptionDs:prop_types_default().object,label:prop_types_default().string.isRequired,name:prop_types_default().string,description:prop_types_default().string,value:prop_types_default().string,checked:prop_types_default().bool,disabled:prop_types_default().bool,labelJsxTemplate:prop_types_default().JSX,onChange:prop_types_default().func},Checkbox.defaultProps={layerDs:{css:{},size:"34",align:"tl",element:"div",minHeightAndWidth:{width:34,height:18}},labelDs:{element:"span",css:{class:{family:"md",fontsize:"sm"},flags:{isDisplay:!1}}},descriptionDs:{css:{class:{fontsize:"sm",margin:{1:2,2:0,3:0,4:0}},flags:{boxSizing:!0}}},name:"",description:"",value:"",checked:"",disabled:"",labelJsxTemplate:"",onChange:null},Checkbox.__docgenInfo={description:"",methods:[],displayName:"Checkbox",props:{layerDs:{defaultValue:{value:`{
	css:{
...
//# sourceMappingURL=storybook-ui-libs-components-atoms-form-checkbox-index-stories.6c7ad69f.iframe.bundle.js.map