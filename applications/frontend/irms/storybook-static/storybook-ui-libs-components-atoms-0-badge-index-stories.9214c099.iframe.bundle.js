"use strict";(self.webpackChunkirms=self.webpackChunkirms||[]).push([[7469],{"./src/storybook/ui-libs/components/atoms/0/badge/index.stories.jsx"(__unused_webpack_module,__webpack_exports__,__webpack_require__){__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{Base:()=>Base,__namedExportsOrder:()=>__namedExportsOrder,default:()=>index_stories});var prop_types=__webpack_require__("./node_modules/prop-types/index.js"),prop_types_default=__webpack_require__.n(prop_types),ui_helpers=__webpack_require__("./build/scripts/ui-helpers/index.js"),react=__webpack_require__("./node_modules/react/index.js"),svg=__webpack_require__("./scrap/ui-libs/components/atoms/0/icons/svg.jsx"),font=__webpack_require__("./scrap/ui-libs/components/atoms/0/icons/font.jsx"),React=__webpack_require__("./node_modules/react/index.js"),Comp=(0,react.forwardRef)(function(dprops,forwardedRef){forwardedRef||(0,react.useRef)(null);var rval,leftIcon,rightIcon,leftAvatar,rightAvatar,rval1,props=ui_helpers.element.jsx.props.define({content:"",dsTheme:{size:"",radius:"4"},theme:{colorPairing:{default:"000",hover:"001"}},avatar:{colorPairing:{left:"",right:""}},config:{icons:{left:{ds:{css:{},theme:{border:{},background:{},colorPairing:{}}},svg:{},attrs:{},markup:{},type:"font",icon:{name:"a-down"}},right:{ds:{css:{},theme:{border:{},background:{},colorPairing:{}}},svg:{},attrs:{},markup:{},type:"font",icon:{name:"a-down"}}},content:{attrs:{},markup:{element:"p"},ds:{css:{},theme:{border:{},background:{},colorPairing:{}}}},wrapper:{attrs:{},markup:{element:"div"},ds:{css:{},theme:{border:{},background:{},colorPairing:{}}}}}},dprops),wrpConfig=ui_helpers.element.jsx.getCompThemeDs((rval=ui_helpers.json.get(props,"config.wrapper",{}),ui_helpers.json.merge(rval,{ds:{theme:props.theme||{},predefined:ui_helpers.json.get(props,"dsTheme",{})}})),"badge"),elm=ui_helpers.json.get(wrpConfig,"config.wrapper.markup.element","div"),hasIcon=function hasIcon(type){var _iconf_icon,_iconf_svg,iconf=ui_helpers.json.get(props,"config.icons.".concat(type),{});return"font"===iconf.type?null==iconf||null==(_iconf_icon=iconf.icon)?void 0:_iconf_icon.name:"svg"===iconf.type?null==iconf||null==(_iconf_svg=iconf.svg)?void 0:_iconf_svg.src:void 0},hasAvatar=function hasAvatar(type){return ui_helpers.json.get(props,"avatar.".concat(type),"")},icon=function icon(type){var iconf=ui_helpers.json.get(props,"config.icons.".concat(type),{});if(iconf&&iconf.type){if("font"===iconf.type)return React.createElement(font.A,{config:iconf});if("svg"===iconf.type)return React.createElement(svg.A,{config:iconf})}return React.createElement(React.Fragment,null)},avatar=function avatar(type){return hasAvatar(type)};return React.createElement(elm,ui_helpers.element.jsx.attrs(wrpConfig,(leftIcon=hasIcon("left"),rightIcon=hasIcon("right"),leftAvatar=hasAvatar("left"),rightAvatar=hasAvatar("right"),rval1=["badge flx-vc bxs anim"],(leftAvatar||rightAvatar)&&rval1.push("has-avatar"),leftAvatar&&rval1.push("has-left-avatar"),rightAvatar&&rval1.push("has-right-avatar"),(leftIcon||rightIcon)&&rval1.push("has-ico"),leftIcon&&rval1.push("has-left-ico"),rightIcon&&rval1.push("has-right-ico"),rval1.join(" "))),props.children?props.children:React.createElement(React.Fragment,null,avatar("left"),icon("left"),function content(){var leftIcon=hasIcon("left"),rightIcon=hasIcon("right");if(!leftIcon&&!rightIcon)return ui_helpers.element.jsx.getChild({content:props.content},null,props.children,props);var ctntConfig=ui_helpers.json.get(props,"config.content",{}),Elem=ui_helpers.json.get(props,"config.content.markup.element","div");return React.createElement(Elem,ui_helpers.element.jsx.attrs(ctntConfig,"flx-full bxs badge-content"),ui_helpers.element.jsx.getChild({content:props.content},null,props.children,props))}(),icon("right"),avatar("right")))});Comp.propTypes={content:prop_types_default().any,dsTheme:prop_types_default().object,theme:prop_types_default().object,avatar:prop_types_default().object,config:prop_types_default().object},Comp.defaultProps={content:"",dsTheme:{size:"",radius:"4"},theme:{colorPairing:{default:"000",hover:"001"}},avatar:{colorPairing:{left:"",right:""}},config:{icons:{left:{ds:{css:{},theme:{border:{},background:{},colorPairing:{}}},svg:{},attrs:{},markup:{},type:"font",icon:{name:"a-down"}},right:{ds:{css:{},theme:{border:{},background:{},colorPairing:{}}},svg:{},attrs:{},markup:{},type:"font",icon:{name:"a-down"}}},content:{attrs:{},markup:{element:"p"},ds:{css:{},theme:{border:{},background:{},colorPairing:{}}}},wrapper:{attrs:{},markup:{element:"div"},ds:{css:{},theme:{border:{},background:{},colorPairing:{}}}}}},Comp.__docgenInfo={description:"",methods:[],displayName:"Comp",props:{content:{defaultValue:{value:'""',computed:!1},description:"Content can have any option like, string, function and JSX element",type:{name:"any"},required:!1},dsTheme:{defaultValue:{value:`{
	size:'',
	radius:"4"
}`,computed:!1},description:"Callback functions",type:{name:"object"},required:!1},theme:{defaultValue:{value:`{
	colorPairing:{
		default:"000",
		hover:"001"
	}
}`,computed:!1},description:"Callback functions",type:{name:"object"},required:!1},avatar:{defaultValue:{value:`{
	colorPairing:{
		left:'',
		right:''
	}
...
}`,computed:!1},description:"Default button",type:{name:"object"},required:!1}}};let index_stories={title:"Atoms/0/Badge",component:Comp,parameters:{layout:"centered",docs:{description:{component:"Button<br/><br /><strong>Import path:</strong><code>import Badge from 'aio-global-ui/atoms/0/badge';</code><br /><strong>Component directory:</strong><code>./libs/frontend/ui/components/atoms/0/badge/index</code><br/><br/>"}}},tags:["autodocs"],argTypes:{}};var Base={args:{content:"",dsTheme:{size:"",radius:"4"},theme:{colorPairing:{default:"000",hover:"001"}},avatar:{colorPairing:{left:"",right:""}},config:{icons:{left:{ds:{css:{},theme:{border:{},background:{},colorPairing:{}}},svg:{},attrs:{},markup:{},type:"font",icon:{name:"a-down"}},right:{ds:{css:{},theme:{border:{},background:{},colorPairing:{}}},svg:{},attrs:{},markup:{},type:"font",icon:{name:"a-down"}}},content:{attrs:{},markup:{element:"p"},ds:{css:{},theme:{border:{},background:{},colorPairing:{}}}},wrapper:{attrs:{},markup:{element:"div"},ds:{css:{},theme:{border:{},background:{},colorPairing:{}}}}},attrs:{},dataAttrs:{}}};Base.parameters={...Base.parameters,docs:{...Base.parameters?.docs,source:{originalSource:`{
  args: {
    content: '',
    dsTheme: {
      size: '',
...
//# sourceMappingURL=storybook-ui-libs-components-atoms-0-badge-index-stories.9214c099.iframe.bundle.js.map