"use strict";(self.webpackChunkirms=self.webpackChunkirms||[]).push([[3084],{"./src/storybook/ui-libs/components/atoms/form/toggle/index.stories.jsx"(__unused_webpack_module,__webpack_exports__,__webpack_require__){__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{Base:()=>Base,__namedExportsOrder:()=>__namedExportsOrder,default:()=>index_stories});var prop_types=__webpack_require__("./node_modules/prop-types/index.js"),prop_types_default=__webpack_require__.n(prop_types),ui_helpers=__webpack_require__("./build/scripts/ui-helpers/index.js"),react=__webpack_require__("./node_modules/react/index.js"),typography_text=__webpack_require__("./scrap/ui-libs/components/atoms/typography/text/index.jsx"),display=__webpack_require__("./scrap/ui-libs/components/atoms/typography/display/index.jsx"),layer_holder=__webpack_require__("./scrap/ui-libs/components/atoms/layer-holder/index.jsx");function _define_property(obj,key,value){return key in obj?Object.defineProperty(obj,key,{value:value,enumerable:!0,configurable:!0,writable:!0}):obj[key]=value,obj}function _object_spread(target){for(var i=1;i<arguments.length;i++){var source=null!=arguments[i]?arguments[i]:{},ownKeys=Object.keys(source);"function"==typeof Object.getOwnPropertySymbols&&(ownKeys=ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function(sym){return Object.getOwnPropertyDescriptor(source,sym).enumerable}))),ownKeys.forEach(function(key){_define_property(target,key,source[key])})}return target}var Toggle=function Toggle(dprops){var lblJsx,props=ui_helpers.element.jsx.props.define({},dprops),id=ui_helpers.random.id(10),ids={switch:"".concat(id,"Swtch"),switchName:"".concat(id,"Nme"),switchHolder:"".concat(id,"SwtchHldr")};(0,react.useEffect)(function(){toggle(props.checked)},[props.checked]);var toggle=function toggle(chkd){chkd?ui_helpers.element.attr.set(ids.switch,"checked",!0):ui_helpers.element.attr.remove(ids.switch,"checked")},onChange=function onChange(chcked){ui_helpers.data.type.is(props.onChange,"function")&&props.onChange(chcked,_object_spread({},props,{ids:ids}))},onClick=function onClick(e){var chcked=ui_helpers.element.attr.get(ids.switch,"checked");e.preventDefault(),e.stopPropagation(),toggle(!chcked),onChange(!chcked)},heading=function heading(){var lbl=ui_helpers.json.val(props,"label");if(lbl)return react.createElement(display.A,{content:lbl,ds:ui_helpers.json.val(props,"labelDs"),element:ui_helpers.json.val(props,"labelDs.element","span")})},description=function description(){var desc=ui_helpers.json.val(props,"description");return desc?react.createElement(typography_text.A,{content:desc,ds:ui_helpers.json.val(props,"descriptionDs",{}),moreLess:{enabled:!1}}):react.createElement(react.Fragment,null)};return react.createElement(layer_holder.A,{layer:function switchBox(){return react.createElement("label",{className:"tgl-wrpr tgl th-".concat(ui_helpers.json.val(props,"theme","000")),htmlFor:ids.switch,onClick:function onClick1(e){onClick(e)}},react.createElement("input",{id:ids.switch,type:"checkbox",value:props.value||"",name:props.name||ids.switchName}),react.createElement("span",{className:"tgl-trck transition round"}))},content:(lblJsx=ui_helpers.json.val(props,"labelJsxTemplate"))?react.createElement("label",{className:"cp",htmlFor:ids.switch,onClick:function onClick1(e){onClick(e)}},lblJsx):react.createElement("label",{className:"cp",htmlFor:ids.switch,onClick:function onClick1(e){onClick(e)}},heading(),description()),moreLess:{enabled:!1},attrs:ui_helpers.json.val(props,"attrs",{}),layerDs:ui_helpers.json.val(props,"layerDs",{}),dataAttrs:ui_helpers.json.val(props,"dataAttrs",{}),wrapperDs:ui_helpers.json.val(props,"wrapperDs",{})})};Toggle.propTypes={layerDs:prop_types_default().object,labelDs:prop_types_default().object,descriptionDs:prop_types_default().object,label:prop_types_default().string.isRequired,name:prop_types_default().string,description:prop_types_default().string,value:prop_types_default().string,checked:prop_types_default().bool,disabled:prop_types_default().bool,labelJsxTemplate:prop_types_default().JSX,onChange:prop_types_default().func},Toggle.defaultProps={layerDs:{css:{},size:"50",align:"tl",element:"div",minHeightAndWidth:{width:50,height:20}},labelDs:{element:"span",css:{class:{family:"md",fontsize:"sm"},flags:{isDisplay:!1}}},descriptionDs:{css:{class:{fontsize:"sm",margin:{1:2,2:0,3:0,4:0}},flags:{boxSizing:!0}}},name:"",description:"",value:"",checked:"",disabled:"",labelJsxTemplate:"",onChange:null},Toggle.__docgenInfo={description:"",methods:[],displayName:"Toggle",props:{layerDs:{defaultValue:{value:`{
	css:{
...
}`,computed:!1},description:"Design system configuration of label description text",type:{name:"object"},required:!1},name:{defaultValue:{value:'""',computed:!1},description:"Switch name",type:{name:"string"},required:!1},description:{defaultValue:{value:'""',computed:!1},description:"Switch lable description",type:{name:"string"},required:!1},value:{defaultValue:{value:'""',computed:!1},description:"Value of toggle box",type:{name:"string"},required:!1},checked:{defaultValue:{value:'""',computed:!1},description:"Is toggle by default is active or not",type:{name:"bool"},required:!1},disabled:{defaultValue:{value:'""',computed:!1},description:"Is toggle by default in disabled mode or not",type:{name:"bool"},required:!1},labelJsxTemplate:{defaultValue:{value:'""',computed:!1},description:"JSX template of toggle label",type:{name:"custom",raw:"propTypes.JSX"},required:!1},onChange:{defaultValue:{value:"null",computed:!1},description:"On change call once toggle switched on or off",type:{name:"func"},required:!1},label:{description:"Switch label",type:{name:"string"},required:!0}}};let index_stories={title:"Atoms/Form/Toggle",component:Toggle,parameters:{layout:"centered",docs:{description:{component:"Toggle storybook<br/><br /><strong>Import path:</strong><code>import Toggle from 'aio-global-ui/atoms/form/toggle';</code><br /><strong>Component directory:</strong><code>./libs/frontend/ui/components/atoms/form/toggle/index</code><br/><br/>"}}},tags:["autodocs"],argTypes:{}};var Base={args:{layerDs:{css:{},size:"50",align:"tl",element:"div",minHeightAndWidth:{width:50,height:20}},labelDs:{element:"span",css:{class:{family:"md",fontsize:"sm"},flags:{isDisplay:!1}}},descriptionDs:{css:{class:{fontsize:"sm",margin:{1:2,2:0,3:0,4:0}},flags:{boxSizing:!0}}},label:"",name:"",description:"",value:"",checked:"",disabled:"",labelJsxTemplate:"",attrs:{},dataAttrs:{}}};Base.parameters={...Base.parameters,docs:{...Base.parameters?.docs,source:{originalSource:`{
  args: {
    layerDs: {
      css: {},
      size: "50",
...
//# sourceMappingURL=storybook-ui-libs-components-atoms-form-toggle-index-stories.fd15579a.iframe.bundle.js.map