...
import IbpResultList from 'aio-app-ui-common-molecules/ibp-result-list';
import IbpFormDrawer from 'aio-app-ui-common-molecules/ibp-from-drawer';
import IbpFormInputs from 'aio-app-ui-common-molecules/ibp-form-inputs';
            ...
            return (
                <div className='full'>
                    <div className='full bxs pd-t20 pd-rl20'>
                        <p className='txt-xl fm-md'>User list for item base access permission not found?</p>
                        ...
                        <IbpFormDrawer id={id} {...props} details={{}} />
                    </div>
                </div>
            )
        }else{
