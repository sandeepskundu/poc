...
import EatResultList from 'aio-app-ui-common-molecules/eat-result-list';
            ...
            return (
                <div className='full'>
                    <div className='full bxs pd-t20 pd-rl20'>
                        <p className='txt-xl fm-md'>Employer access team list not found?</p>
                        ...
                        <EatFormDrawer id={id} {...props} details={{}} />
                    </div>
                </div>
            )
        }else{
