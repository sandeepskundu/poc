...
import OfficeResultList from 'aio-app-ui-common-molecules/office-result-list';
import OfficeFormInputs from 'aio-app-ui-common-molecules/offices-form-inputs';
import OfficeFormDrawer from 'aio-app-ui-common-molecules/offices-form-drawer'
            ...
            return (
                <div className='full'>
                    <div className='full bxs pd-t20 pd-rl20'>
                        <p className='txt-xl fm-md'>Office list not found?</p>
