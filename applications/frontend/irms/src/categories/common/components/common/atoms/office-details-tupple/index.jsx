...
const Comp = (dprops) => {
    ...
    const updateLink = () => {
        return <li className='mr-l16 link-u ns cp txt-xs' onClick={() => {helpers.url.route.redirect('common.offices', {params:{action:'update', eId:eId, id:details.vd.id}})}}>Details</li>
    }
