...
import ArResultList from 'aio-app-ui-common-molecules/ar-result-list';
import ArFormDrawer from 'aio-app-ui-common-molecules/ar-from-drawer';
import ArFormInputs from 'aio-app-ui-common-molecules/ar-form-inputs';
            ...
            return (
                <div className='full'>
                    <div className='full bxs pd-t20 pd-rl20'>
                        <p className='txt-xl fm-md'>Role list not found?</p>
                        ...
                        <ArFormDrawer id={id} {...props} details={{}} />
                    </div>
                </div>
            )
        }else{
