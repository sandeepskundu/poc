...
import BusinessVerticalsHeader from 'aio-app-ui-common-organisms/business-verticals-header';
import BusinessVerticalsListUi from 'aio-app-ui-common-organisms/business-vertical-list-ui';
...
const Comp = (dprops) => {
    ...
    const details = () => {
        let req = request('common.bvs.detailsByHashId', id);
    ...
    if(fristRender){
        helpers.store.getDetailsById([request('common.bvs.listByParentId', pId?pId:buId)], onResultResp); 
    }

    return (
        <>
            <BusinessVerticalsHeader {...data} />
            <BusinessVerticalsListUi {...data} />
        </>
    )
}
