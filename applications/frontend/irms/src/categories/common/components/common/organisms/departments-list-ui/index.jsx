...
import DepartmentsResultList from 'aio-app-ui-common-molecules/departments-result-list';
import DepartmentFormInputs from 'aio-app-ui-common-molecules/departments-form-inputs';
import DepartmentFormDrawer from 'aio-app-ui-common-molecules/departments-form-drawer'
            ...
            return (
                <div className='full'>
                    <div className='full bxs pd-t20 pd-rl20'>
                        <p className='txt-xl fm-md'>Departments is not found?</p>
