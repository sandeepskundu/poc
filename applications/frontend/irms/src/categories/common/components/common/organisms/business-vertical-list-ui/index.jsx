...
import BusinessVerticalResultList from 'aio-app-ui-common-molecules/business-vertical-result-list';
    ...
    const form = () => {
         return (
            <div className='full pd-rl24 pd-t30 bxs'>
                <BusinessVerticalFormInputs {...props} />
            </div>
        )
    }
            ...
            return (
                <div className='full'>
                    <div className='full bxs pd-t20 pd-rl20'>
                        <p className='txt-xl fm-md'>Business verticals list not found?</p>
                        ...
                        <BusinessVerticalFormDrawer id={id} {...props} details={{}} />
                    </div>
                </div>
            )
        }else{
    ...
    const list = () => {
        if(action === 'update' && !blank){
            ...
            if(blank || results.length > 0){
                return (
                    <BusinessVerticalResultList {...props} />
                )
            }else{
                return noResults();
            }
