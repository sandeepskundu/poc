...
import BusinessUnitHeader from 'aio-app-ui-common-organisms/business-unit-header';
import BusinessUnitListUi from 'aio-app-ui-common-organisms/business-unit-list-ui';
...
const Comp = (dprops) => {
    ...
    const details = () => {
        let req = request('common.bus.detailsById', id);
    ...
    if(fristRender){
        helpers.store.getDetailsById([request('common.bus.rootList', eId)], onResultResp); 
    }

    return (
        <>
            <BusinessUnitHeader {...data} />
            <BusinessUnitListUi {...data} />
        </>
    )
}
