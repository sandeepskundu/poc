...
import RoleHaveChildFlag from 'aio-app-ui-access-atoms/have-childs-flag';
...
const AddNewNode = (dprops) => {
    ...
    const api = () => {
        if(action === 'update'){
            mhelper.api.updateRole.init(onResp, {
                request:{
                    data:data(),
                    params:{
            ...
            mhelper.api.createRole.init(onResp, {
                request:{
                    data:data()
                }
            });
    ...
    const ui = () => {
        return (
            <ul className='full bxs'>
                ...
                <li className='full pd-b24'>
                    <RoleHaveChildFlag  {...props} details={details.data} validation={details.validation} key={cache} onChange={onChange} />
                </li>
