...
import AddNewLink from 'aio-app-ui-tdc-molecules/ui-app-add-scss-new-data-map';
import UiAppicationScssDataMap from 'aio-app-ui-tdc-atoms/ui-app-scss-data-map';
...
const Comp = (dprops) => {
    ...
    const onChange = (data) => {
        let d = helpers.json.copy(details);
            d = helpers.json.set(d, map, data || {}, false, true);
    ...
    const ui = () => {
        return (
            <div className='full bxs'>
                <div className='full bxs flx-sb'>
                    <span className='full bxs pd-rl14 pd-tb12 txt-sm fm-md'>Run time scss additional variables</span>
                    <ul className='bxs flx-vc nowrap'>
                        {addNew()}
                    </ul>
                </div>
                {list()}
