...
import AppHooksUi from 'aio-app-ui-tdc-organisms/app-hooks-ui';
import AppConfigsUI from 'aio-app-ui-tdc-organisms/app-configs-ui';
import AppScssConfigUi from 'aio-app-ui-tdc-organisms/app-scss-configs-ui';
    ...
    const details = (arg) => {
        ...
        if(exp){
            switch (type) {
                case 'appConfig':
                    return (
                        <AppConfigsUI {...props} valuemap={[...valmap]} />
                    )
                break;
                case 'scssConfig':
                    return (
                        <AppScssConfigUi {...props} valuemap={[...valmap]} />
                    )
                break;
                case 'hooks':
                    return (
                        <AppHooksUi {...props} valuemap={[...valmap]} />
                    )
                break;
                default :
                    return <></>
