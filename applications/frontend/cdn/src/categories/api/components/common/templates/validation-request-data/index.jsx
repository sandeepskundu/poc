...
import ValidationReqDataTypes from 'aio-app-ui-api-organisms/validation-req-data-types';
...
const Comp = (dprops) => {
    ...
    return (
        <div className='full bxs pd-rl20'>
            {ui()}
        </div>
    )
}
