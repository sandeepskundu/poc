...
import MergeSwitch from 'aio-app-ui-api-atoms/model-signature/merge-switch';
import CreationSwitch from 'aio-app-ui-api-atoms/model-signature/creation-switch';
import CreationNodes from 'aio-app-ui-api-molecules/model-config/signature/creation-nodes';
...
const ValidationDetailsMapper = (dprops) => {
    ...
    const header = () => {
        return (
            <>
                <p className='txt-md fm-md'>Signature</p>
            </>
        )
    }
