...
import PaginationSwitch from 'aio-app-ui-api-atoms/model-pagination/pagination-switch';
import PaginationLimitInput from 'aio-app-ui-api-atoms/model-pagination/pagination-limit-input';
...
const ValidationDetailsMapper = (dprops) => {
    ...
    const header = () => {
        return (
            <>
                <p className='txt-md fm-md'>Pagination</p>
            </>
        )
    }
