...
import HiddenSwitch from 'aio-app-ui-api-atoms/model-query/hidden-switch';
import RuntimeSwitch from 'aio-app-ui-api-atoms/model-query/runtime-switch';
import HiddenColumns from 'aio-app-ui-api-molecules/model-config/query/hidden-columns';
import RuntimeConfigs from 'aio-app-ui-api-molecules/model-config/query/runtime-configs';
...
const ModelQuery = (dprops) => {
    ...
    const header = () => {
        return (
            <>
                <p className='txt-md fm-md'>Query</p>
            </>
        )
    }
