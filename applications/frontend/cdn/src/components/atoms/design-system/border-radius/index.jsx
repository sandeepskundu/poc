...
const BorderRadius = (props) => {
    ...
    const heading = 'Border Radius'
    const id = helpers.random.id(10);
    const vmap = 'ds.css.class.radius';
    const list = helpers.json.val(props, 'dsData.border.radius', {});
    ...
    const ui = () => {
        return types.map((arg, i) => {
            return (
                <div className='full bxs pd-t24 _grid-4 _pd-r16' key={id+i}>
                    <SelectBox 
                        list={list}
