...
import mhelpers from 'aio-app-ui-tdc-backend-modules';
import React, {useEffect, useState, useRef} from 'react';
import ColumnQuery from 'aio-app-ui-tdc-application-molecules/model-config/query/add-new-query-form/column-query';
import LogicalForm from 'aio-app-ui-tdc-application-molecules/model-config/query/add-new-query-form/logical-query';
...
const AddNewQuery = (dprops) => {
    ...
    const onAction = (qury, action, map) => {
        if(props.onAction){
            ...
            case 'query':
                return (
                    <ColumnQuery
                        ...
                        queryData={helpers.json.val(props, 'queryData', {})}
                        onAction={(qury, action, map) => {onAction(qury, action, map)}}
                    />
                )
            break;
            case 'or':
