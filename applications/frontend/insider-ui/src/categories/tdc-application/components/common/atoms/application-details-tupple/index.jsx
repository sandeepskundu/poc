...
const Comp = (dprops) => {
    ...
    const controllerLink = () => {
        helpers.url.route.redirect('tdc-application.controller', {
            params:{
                type:'controller',
                appId:helpers.json.val(details, 'id')
            }
        })
    }
    ...
    const controller = () => {
        if(type === 'api'){
            return <li className='mr-l16 link-u' onClick={() => {controllerLink()}}>Controllers</li>
        }
    }
                    ...
                    <ul className='full flx-sb flx-vc'>
                        ...
                        <li className='txt-sm'>
                            <ul className='flx-vc'>
                                ...
                                <li className='mr-l16 link-u' onClick={() => {update('fetch')}}>view</li>
                                {controller()}
                            </ul>
                        </li>
                    </ul>
