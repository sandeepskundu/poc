...
import QueryDetailsView from 'aio-app-ui-tdc-application-molecules/model-config/query/details-view';
import QueryDetailsInputs from 'aio-app-ui-tdc-application-molecules/model-config/query/details-inputs';
...
const QueryChildDetails = (dprops) => {
    ...
    const expend = (() => {
        let map = helpers.json.val(props, 'mapping', []);
            map = map.join('.');
