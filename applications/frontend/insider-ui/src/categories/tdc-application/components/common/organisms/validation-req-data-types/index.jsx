...
import AddNewDelete from 'aio-app-ui-tdc-application-molecules/data-validation-req-delete';
import ValidationReqDataDetails from 'aio-app-ui-tdc-application-organisms/validation-req-data-details';
...
const Comp = (dprops) => {
    ...
    const expend = (() => {
        return (active.indexOf(`${parentId}.${type}`) === 0)
    })();
