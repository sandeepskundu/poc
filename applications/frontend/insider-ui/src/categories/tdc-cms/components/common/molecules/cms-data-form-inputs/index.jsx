...
import CmsDataNameInput from 'aio-app-ui-tdc-cms-atoms/cms-data-name-input';
import CmsDataExposedDetails from 'aio-app-ui-tdc-cms-atoms/cms-data-exposed-input';
import CmsDataHaveChildFlag from 'aio-app-ui-tdc-cms-atoms/cms-data-have-childs-flag';
import CmsDataDescriptionInput from 'aio-app-ui-tdc-cms-atoms/cms-data-description-input';
import CmsDataInfoDetailsInputs from 'aio-app-ui-tdc-cms-molecules/cms-data-info-details-inputs'
...
const AddNewNode = (dprops) => {
        ...
        if(details.hasChilds){
            ...
            return (
                <li className='full pd-b24'>
                    <CmsDataInfoDetailsInputs {...props} details={details} key={cache} onChange={onChange} />
                </li>
            )
        }
    }
    ...
    const create = () => {
        ...
        if(d.hasChilds){
            if(d.parentId){
                mhelper.api.createChildCmsData.init(onResp, req);
            }else{
                mhelper.api.createRootCmsData.init(onResp, req);
            }
        }else{
            mhelper.api.addCmsDataInfo.init(onResp, req);
        }
    }
    ...
    const ui = () => {
        return (
            <ul className='full bxs'>
                <li className='full pd-b24'>
                    <CmsDataNameInput {...props} details={details} key={cache} onChange={onChange} />
                </li>

                <li className='full pd-b24'>
                    <CmsDataDescriptionInput {...props} details={details} key={cache} onChange={onChange} />
                </li>

                <li className='full pd-b24'>
                    <CmsDataExposedDetails {...props} details={details} key={cache} onChange={onChange} />
                </li>

                <li className='full pd-b24'>
                    <CmsDataHaveChildFlag  {...props} details={details} key={cache} onChange={onChange} />
                </li>
