...
import CmsDataResultsList from 'aio-app-ui-tdc-cms-molecules/cms-data-results-list';
                ...
                return (
                    <div className='full'>
                        <div className='full bxs pd-t20 pd-rl20'>
                            <p className='txt-xl fm-md'>Child cms data is not found?</p>
            ...
            if(action === 'update'){
                ...
                return (
                    <div className='full pd-rl24 pd-t30 bxs'>
                        <CmsDataFormInputs {...props} details={details} />
                    </div>
                )
            }
        }
