const basePackageJson = {
    ...
    "scripts": {
        ...
        "start-watch":"nodemon __BUILD_DIR__/__SCRIPTS_DIR__/server.js",
        "start-dev":"nodemon --inspect=__INSPECT_AT__ __BUILD_DIR__/__SCRIPTS_DIR__/server.js",
        "init-app":"node __SCRIPTS_DIR__/index.js",
    },
    "_moduleAliases": {
...
const inspectAt = (appConfig, req) => {
    let port = req.helpers.json.val(appConfig, 'appConfig.PORT');
    let insp = req.helpers.json.val(appConfig, 'appConfig.INSPECT_AT', 21);
