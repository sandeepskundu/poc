...
exports.get = async (rval, appConfig, req) => {
    return req.helpers.json.merge(rval || {}, {
        "tbmbr/details/v1/byId/fetch":await infoById.get(appConfig, req),
        "tbmbr/details/v1/info/create":await createInfo.get(appConfig, req),
        "tbmbr/details/v1/byId/update":await updateInfo.get(appConfig, req),
        // "tbmbr/details/v1/byTeamId/fetch":await byTeamId.get(appConfig, req)
    });
}