...
exports.get = async (rval, appConfig, req) => {
    return req.helpers.json.merge(rval || {}, {
        "accessPreset/details/v1/getById/fetch":await getById.get(appConfig, req),
        "accessPreset/details/v1/info/create":await createInfo.get(appConfig, req),
        "accessPreset/details/v1/infoById/update":await updateInfo.get(appConfig, req),
        "accessPreset/details/v1/getByMapId/fetch":await getByMapId.get(appConfig, req),
