        ...
        "body":{
            ...
            "details.type":{
                "message":{
                    "error":{
                        "checks":{
                            "enums":"Please provide type value",
                            "required":"Please provide type value"
                        }
                    }
                },
                "checks":{
            ...
            "details.props":{
                "message":{
                    "error":{
                        "checks":{
                            "enums":"Please provide props values",
                            "required":"Please provide props values"
                        }
                    }
                },
                "checks":{
            ...
            "details.children":{
                "message":{
                    "error":{
                        "checks":{
                            "enums":"Please provide children data values",
                            "required":"Please provide children data values"
                        }
                    }
                },
                "checks":{
