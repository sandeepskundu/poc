...
const getSalt = async (key, req) => {
    let sec = req.helpers.json.val(constants, 'ENCRIPTION_KEY.ACCOUNT_CREATE_ACCOUNT', '');
...
const get = async (req, res) => {
    const tkn = req.helpers.json.val(req, 'body.data.otp.token', '');
    const tId = req.helpers.json.val(req, 'body.data.otp.trackId', '')
